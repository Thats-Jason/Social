package com.wisnusaputra.pinekaapp.Adapter;
...
import com.wisnusaputra.pinekaapp.Activity.AddStoryActivity;
import com.wisnusaputra.pinekaapp.Model.Story;
import com.wisnusaputra.pinekaapp.Model.User;
import com.wisnusaputra.pinekaapp.R;
import com.wisnusaputra.pinekaapp.Activity.StoryActivity;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder>{
    ...
    private void userInfo(final ViewHolder viewHolder, String userid, final int pos){
        DatabaseReference reference = FirebaseDatabase.getInstance("https://social-media-debc4-default-rtdb.firebaseio.com/").getReference("Users").child(userid);
